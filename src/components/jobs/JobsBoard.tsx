...
export function JobsBoard({
  ...
  useEffect(() => {
    ...
    console.log("[JobsBoard] checking auto-open:", { isNew, stagesCount: stages.length, newStageOpen: !!newStage });
    if (isNew && stages.length > 0 && !newStage) {
      console.log("[JobsBoard] autoOpen active, opening NewJobDialog NOW");
