...
export async function fetchTransactions(filters: {
  ...
  let q = supabase
    .from("transactions")
    .select("*, extra_demands(id, number_display, title), clients(id, name, company, logo_url), categorias_financeiras(id, nome, tipo), suppliers(id, name), freelancer:partners!transactions_freelancer_id_fkey(id, name, photo_url)")
