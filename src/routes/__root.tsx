...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://fduofhsiahyxvlaxthhe.supabase.co/storage/v1/object/public/logos/logo-yellow.png" },
      { name: "twitter:image", content: "https://fduofhsiahyxvlaxthhe.supabase.co/storage/v1/object/public/logos/logo-yellow.png" },
    ],
    links: [
      ...
      { rel: "icon", href: "/kasa-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/kasa-logo.png" },
    ],
  }),
