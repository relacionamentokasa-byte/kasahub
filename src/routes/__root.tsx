...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KASA HUB — Sistema de Gestão Inteligente" },
      ...
      { property: "og:title", content: "KASA HUB — Sistema de Gestão Inteligente" },
      ...
      { name: "twitter:title", content: "KASA HUB — Sistema de Gestão Inteligente" },
