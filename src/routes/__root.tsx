...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://kasahub.lovable.app/icon-512.png" },
      { property: "og:image:secure_url", content: "https://kasahub.lovable.app/icon-512.png" },
      { property: "og:image:type", content: "image/png" },
      { property: "og:image:width", content: "512" },
      { property: "og:image:height", content: "512" },
      { name: "twitter:image", content: "https://kasahub.lovable.app/icon-512.png" },
    ],
    links: [
