...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KASA OS — Sistema de Gestão Inteligente" },
      ...
      { property: "og:title", content: "KASA OS — Sistema de Gestão Inteligente" },
      ...
      { name: "twitter:title", content: "KASA OS — Sistema de Gestão Inteligente" },
